...
uses
  ...
  Clientes, Comum, Correios, ListaUsuarioEClientes, Vcl.CustomizeDlg,
  Vcl.ExtCtrls, Vcl.Buttons, RxCtrls;
...
begin
   ...
   begin
      ClientDataSetCliente.LoadFromFile(ExtractFilePath(ParamStr(0))+'clientes.xml');   // carrega o xml   no client
   end;

   if(FileExists(ExtractFilePath(ParamStr(0))+'usuarios.xml'))then
   begin
      ClientDataSetUsuario.LoadFromFile(ExtractFilePath(ParamStr(0))+'usuarios.xml');  // carrega o xml   no client
   end;
